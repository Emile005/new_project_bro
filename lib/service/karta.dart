...
class Karta {
  static KartaService service = KartaService();
  static final Map<int, Karta> obyektlar = {};
  ...
  Karta.fromJson(Map<String, dynamic> json) {
  ...
  Future<int> insert() async {
    ...
    Karta.obyektlar[id] = this;
    return id;
  }

  Future<void> delete() async {
    Karta.obyektlar.remove(id);
...
class KartaService extends CrudHelper {
  @override
  KartaService({super.prefix = ''}) : super("car");
